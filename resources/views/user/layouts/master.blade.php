        ...
        <div class="container px-0">
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                <a href="{{ route("user#home") }}" class="navbar-brand">
                    <h1 class="text-primary display-6">UniShop</h1>
                </a>
                ...
                <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                    ...
                    <div class="d-flex m-3 me-0">
                        ...
                        <a href="{{ route("user#listOrder") }}" class="position-relative me-4 my-auto">
                            <i class="fa-solid fa-list-check fa-2x"></i>
                        </a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle my-auto mt-2" data-bs-toggle="dropdown">
                                <img src="{{ is_null(Auth::user() -> profile) ? asset("admin/img/undraw_profile.svg") : asset("user/profile/" . Auth::user() -> profile) }}" style="width: 50px; height: 50px" class="img-profile  rounded-circle" alt="">
        ...
        <div class="container py-5">
            <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
                <div class="row g-4">
                    <div class="col-lg-3">
                        <a href="#">
                            <h1 class="text-primary mb-0">UniShop</h1>
                            <p class="text-secondary mb-0">Campus Accessories</p>
                        </a>
                    </div>
                    <div class="col-lg-6">
