                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-3">
                            ...
                            <img class="img-profile img-thumbnail" id="output" src="{{ is_null(Auth::user() -> profile) ? asset("admin/img/undraw_profile.svg") : asset("admin/profile/" . Auth::user() -> profile) }}">
                        ...
                        <div class="col">
                            ...
                            <div>
                                <a href="{{ route("profile#renderPasswordChangePage") }}">Change Password</a>
                            </div>
